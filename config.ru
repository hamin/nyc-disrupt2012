...
KloutClient = Klout::API.new # ENV['KLOUT_API_KEY']

Twitter.configure do |config|
  config.consumer_key = ENV['TW_CONSUMER_KEY']
  config.consumer_secret = ENV['TW_CONSUMER_SECRET']
  config.oauth_token = ENV['TW_AUTH_TOKEN']
  config.oauth_token_secret = ENV['TW_AUTH_SECRET']
end
